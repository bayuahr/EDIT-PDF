...
def main():
    ...
    if st.button("Process PDF"):
        ...
        print("axa.pdf")
        existing_pdf = PdfFileReader(open("https://bayuahr.github.io/EDIT-PDF/axa_fix.pdf", "rb"))
        output = PdfFileWriter()
        page = existing_pdf.getPage(0)
        page.mergePage(new_pdf.getPage(0))
        output.addPage(page)
        outputStream = open("https://bayuahr.github.io/EDIT-PDF/dest.pdf", "wb")
        output.write(outputStream)
        outputStream.close()
        with c2:
            displayPDF("https://bayuahr.github.io/EDIT-PDF/dest.pdf")
